...
{
  static int shape_position_y_2 = HEIGHT/2, move_x = defaultSize;
  static int shape_position_x_2 = WIDTH/2, move_y = defaultSize;
  ...
  switch(c) {
    ...
    case 27:
      ...
      break;
    case 'a':
      shape_position_x_2 -= move_x;
      break;
    case 'd':
      shape_position_x_2 += move_x;
      break;
    case 'w':
      shape_position_y_2 -= move_y;
      break;
    case 's':
      shape_position_y_2 += move_y;
      break;
  ...
  toSend << myPID2 << ' ' << shape_position_x_2 << ' ' << shape_position_y_2;
  toSend.flush();
  // cout << "toSend has " << toSend.str() << endl;
  multicast(toSend.str().c_str());
}

// process "special" keyboard events (those having to do with arrow keys or WASD)
